...
<body>
 ...
 <form  method="post">
            <input type="submit" id="driver" name="gmap" value="View Map" class="action-button shadow animate blue">
               
            <input type="submit" id="driver" name="lgouts" value="Log Out" class="action-button shadow animate blue"><br><br><br>
 ...
 <form  method="post" action="Messenger/chat.php" name="form2">
     <input type="text" id="driver" required name="usertable"  placeholder="Your ID"  /><br>
      <input type="submit" id="driver" name="chatroom" onclick="return checkForm2()" value="Chat Box" class="action-button shadow animate yellow">
...
<?php 
 ...
 $username=$_POST['usertable']; 
 
 $sql="SELECT * FROM customerlogin WHERE cust_id='$username'";
 $sql1="SELECT * FROM driverlogin WHERE dri_id='$username'";
 ...
 if(isset($_POST['usertable'])){
     if ($count==1||$count1==1) {
      $_SESSION['loggedin']=true;
            echo "<script>window.open('Messenger/chat.php')</script>";
 ...
 if(isset($_POST['gmap'])){
     ob_start();
      ...
      $_SESSION['loggedin']=true;
            echo "<script>window.open('googleMap.php')</script>";
 ...
 if(isset($_POST['start']) ){
    echo "<script>alert('Please Check your chat box...')</script>";
